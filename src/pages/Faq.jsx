      ...
      <div className="faq-body">
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            number of times that interest is compounded per year. t is the time
            the money is invested for in years.
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            or deposit, whereas compound interest is calculated on the principal
            amount and also on the accumulated interest of previous periods.
            Thus, compound interest can grow the amount of money faster than
            simple interest.
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            interest is continually calculated on the accumulated interest from
            previous periods.
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            you owe money and the interest is compounded, the amount you owe can
            grow quickly, making it harder to pay off the debt over time.
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            deposits, retirement accounts, and other investment vehicles. It is
            also used in calculating interest for loans, such as mortgages and
            credit cards.
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            investment vehicles. Diversifying your investments can help mitigate
            some of these risks.
          </AccordionDetails>
        </Accordion>
        <Accordion>
          ...
          <AccordionDetails>
            Compound interest on loans means that you are paying interest on the
            accumulated interest as well as the principal. This can cause the
            total amount owed to grow significantly over time, especially if
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            exponential growth. The formula used is A = Pe^(rt), where e is the
        ...
        <Accordion>
          ...
          <AccordionDetails>
            Compound interest on credit card debt can significantly increase the
            amount owed if the balance is not paid off in full each month.
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            This includes strategies like dividend reinvestment, where dividends
            earned from stocks are used to purchase more shares, thus increasing
            future potential dividends and capital gains.
          </AccordionDetails>
        </Accordion>
      </div>
    </div>
